...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { key: 'courses',           label: 'Courses',           icon: '◈', group: 'Offerings', path: '/courses',          color: 'bg-indigo-500' },
  { key: 'engagements',       label: 'Engagements',       icon: '◇', group: 'Offerings', path: '/engagements',      color: 'bg-rose-500' },
