-- ============================================================================
-- MIGRATION 048: Fix delete_organization FK constraint ordering
-- ============================================================================
-- The profiles table has FK references to assistant_mentors (prayer_partner_id)
-- and staff (staff_id). The previous version tried to delete assistant_mentors
-- and staff before profiles, causing FK violation errors.
--
-- Fix: Move profiles deletion before assistant_mentors, mentors, and staff.
-- ============================================================================
...
BEGIN
  ...
  -- profiles must be deleted BEFORE assistant_mentors, mentors, and staff
  -- because profiles has FK references: prayer_partner_id -> assistant_mentors(id)
